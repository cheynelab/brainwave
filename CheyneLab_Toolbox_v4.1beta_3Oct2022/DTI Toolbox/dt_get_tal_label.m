function [s1, s2, s3, s4, s5, range] = dt_get_tal_label(tal_coords, searchRadius)
...
talFile = sprintf('%s%satlases%sTalairach%stalairach_data.mat', DT_PATH,filesep,filesep,filesep);
t = load(talFile);
talairach_data = t.talairach_data;
