function mri = bw_ctf_read_mri(file)
%       BW_CTF_READ_MRI 
%
%   function mri = bw_ctf_read_mri(file)
%
%   DESCRIPTION: Taking the CTF version 2.2 .mri file specified by file 
%   this function will read the file and output the information in the
%   structure mri.
%
...
% $Revision: 1.5 $ $Date: 2004/12/26 07:50:23 $
...
[fid,message] = fopen(mri.file,'rb','s','latin1');
