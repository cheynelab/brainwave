function bw_grand_average_analyze_files(listFile, fileprefix, plotAverage, spmVersion, writeLAS)
%       BW_GRAND_AVERAGE_ANALYZE_FILES 
%
%   function bw_grand_average_analyze_files(listFile, fileprefix, displaycheck,spmVersion,writeLAS)
%
